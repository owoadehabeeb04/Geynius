...
function Template3Footer(): ReactElement {
  ...
  const socialArray = [
    {
      ...
      image: whatsapp,
      link:
      Object.keys(profilePortfolioForm).length > 0 && profilePortfolioForm?.Whatsapp_Number
          ? `https://api.whatsapp.com/send?phone=${profilePortfolioForm?.Whatsapp_Number}&text=Hello%20there!`
          : '#',
    },
    {
      name: 'Mobile Phone',
      image: mobilephone,
      link:
      Object.keys(profilePortfolioForm).length > 0 && profilePortfolioForm?.Phone_Number
          ? `tel:${profilePortfolioForm?.Phone_Number}`
          : '#',
    },
    {
      name: 'Email Address',
      image: email,
      link:
      Object.keys(profilePortfolioForm).length > 0 && profilePortfolioForm?.Email_Address
          ? `mailto:${profilePortfolioForm?.Email_Address}`
          : '#',
    },
  ]
  return (
