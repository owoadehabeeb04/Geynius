...
function PreviewPortfolioHero3(): ReactElement {
  ...
  const { setShowModal, showModal }: any = useStateContext()
  return (
    <div
      id='/portfolioPage'
      ...
      <div className='text-white lg:place-content-center '>
        <div className=''>
          ...
          <p className='text-[#818181] leading-[1.75rem] sm:leading-[2.25rem] font-normal text-[1.125rem] mt-[20px]'>
            I am a versatile software engineer with expertise in full-stack development and software
            architecture, combining a meticulous approach to coding with a focus on user experience
            and performance. I possess a deep understanding of various technologies and development
            methodologies, enabling me to deliver robust and scalable solutions while ensuring
          ...
          <div className='flex sm:flex-row mt-8 flex-col gap-6'>
            ...
            <button className='text-[0.875rem] sm:text-[1.25rem] w-fit font-normal  flex justify-center items-start flex-col py-[1.0625rem] px-[2.8125rem] rounded-lg  border-2  border-[#2790C4] text-[#2790C4] font-space  disabled:bg-white disabled:border-white'>
              {' '}
              Download CV{' '}
            </button>
          </div>
...
export default PreviewPortfolioHero3;
